...
<div class="filterSection numberrange js_filterparent">
	...
	<input class="js_optionvaluefield" type="hidden" name="<?= $this->secondfieldname ?>" rel="<?= OnlineShop_Framework_FilterService_AbstractFilterType::EMPTY_STRING ?>" value="<?= $this->currentValue ?>" />

    <h4 class="title"><?= trim($this->label) ?></h4>
