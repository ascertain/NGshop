...
<?php if (!$this->href("productFilter")->isEmpty()) { ?>
    ...
    <?= $this->action("list", "shop", null, array("filterdefinition" =>$this->href("productFilter")->getElement(),"category"=>$this->getParam('parentCategoryIds'),"theme"=>$this->getParam('theme'))) ?>
