...
$this->view->header=$this->getParam("header");
...
$themedetails=$this->showThemes();

$this->view->themedetails=$themedetails;
	...
	$json = array();
		...
		foreach($themes as $theme)
		{
			$json[]= array(
       'name' => $theme->getText(),
     'image' => $theme->getImage()->__toString(),
	 'description'=>$theme->getDescription(),
	 'navigation'=>$theme->getNavigationPath(),
	 'id'=>$theme->getId()
          );
		}
