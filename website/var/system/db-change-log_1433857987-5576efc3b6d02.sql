...
ALTER TABLE `object_query_10` ADD COLUMN `description` longtext NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `description` longtext NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `material` longtext NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `material` longtext NULL;
