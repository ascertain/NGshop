...
ALTER TABLE `object_query_10` ADD COLUMN `features` text NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `technologies` text NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `attributes` text NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `collection` text NULL;
