UPDATE `classes` SET `id` = 10, `name` = 'Product', `description` = '', `creationDate` = 1433841364, `modificationDate` = 1433845083, `userOwner` = 2, `userModification` = 2, `parentClass` = 'OnlineShop_Framework_AbstractProduct', `useTraits` = '', `allowInherit` = 0, `allowVariants` = 0, `showVariants` = 0, `icon` = '', `previewUrl` = '', `propertyVisibility` = 'a:2:{s:4:\"grid\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}s:6:\"search\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}}' WHERE (id = 10);
...
ALTER TABLE `object_query_10` DROP INDEX `p_index_colorName`;

/*--NEXT--*/

ALTER TABLE `object_store_10` DROP INDEX `p_index_colorName`;
...
ALTER TABLE `object_query_10` ADD COLUMN `loweragelimit` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `loweragelimit` double NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `upperagelimit` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `upperagelimit` double NULL;
