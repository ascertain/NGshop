...
ALTER TABLE `object_query_10` ADD COLUMN `artno` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `artno` varchar(255) NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `ean` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `ean` varchar(255) NULL;
