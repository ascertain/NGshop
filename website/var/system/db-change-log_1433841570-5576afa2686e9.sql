...
ALTER TABLE `object_query_10` ADD COLUMN `name` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `name` varchar(255) NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `seoname` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `seoname` varchar(255) NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `colorName` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `colorName` varchar(255) NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `price_product` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `price_product` varchar(255) NULL;
