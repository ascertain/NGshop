...
ALTER TABLE `object_collection_FilterTheme_1` ADD COLUMN `label` varchar(255) NULL;
...
ALTER TABLE `object_collection_FilterTheme_1` ADD COLUMN `includeParentCategories` tinyint(1) NULL;

/*--NEXT--*/

ALTER TABLE `object_collection_FilterTheme_1` DROP INDEX `p_index_includeParentCategories`;

/*--NEXT--*/

ALTER TABLE `object_collection_FilterTheme_1` ADD COLUMN `scriptPath` varchar(255) NULL;
