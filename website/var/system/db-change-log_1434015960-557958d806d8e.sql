...
ALTER TABLE `object_collection_FilterTheme_1` ADD COLUMN `includeParentTheme` tinyint(1) NULL;
...
ALTER TABLE `object_collection_FilterTheme_1` DROP COLUMN `includeParentCategories`;
