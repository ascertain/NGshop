...
ALTER TABLE `object_query_14` DROP INDEX `p_index_footerobjectdata`;

/*--NEXT--*/

ALTER TABLE `object_store_14` DROP INDEX `p_index_footerobjectdata`;
