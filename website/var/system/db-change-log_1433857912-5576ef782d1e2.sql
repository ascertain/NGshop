...
ALTER TABLE `object_query_10` ADD COLUMN `imagesInheritance` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `imagesInheritance` varchar(255) NULL;
