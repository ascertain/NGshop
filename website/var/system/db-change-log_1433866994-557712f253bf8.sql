...
ALTER TABLE `object_query_10` ADD COLUMN `size` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `size` varchar(255) NULL;
...
ALTER TABLE `object_query_10` ADD COLUMN `brand__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_10` ADD COLUMN `brand__type` enum('document','asset','object') NULL;
