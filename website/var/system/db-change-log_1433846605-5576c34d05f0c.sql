...
ALTER TABLE `object_query_10` CHANGE COLUMN `price_product` `price_product` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` CHANGE COLUMN `price_product` `price_product` double NULL;
