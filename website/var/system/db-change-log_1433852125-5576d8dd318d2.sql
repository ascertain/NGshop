...
ALTER TABLE `object_query_1` ADD COLUMN `infiniteScroll` tinyint(1) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `infiniteScroll` tinyint(1) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_1` DROP INDEX `p_index_infiniteScroll`;

/*--NEXT--*/

ALTER TABLE `object_store_1` DROP INDEX `p_index_infiniteScroll`;
