...
ALTER TABLE `object_query_10` CHANGE COLUMN `color` `color` text NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` CHANGE COLUMN `color` `color` text NULL;
