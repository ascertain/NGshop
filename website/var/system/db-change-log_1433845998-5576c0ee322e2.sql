...
ALTER TABLE `object_query_10` ADD COLUMN `color` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_10` ADD COLUMN `color` varchar(255) NULL;
...
ALTER TABLE `object_query_10` DROP COLUMN `colorName`;

/*--NEXT--*/

ALTER TABLE `object_store_10` DROP COLUMN `colorName`;
