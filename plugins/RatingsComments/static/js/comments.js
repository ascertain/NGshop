pimcore.registerNS("pimcore.plugin.ratingscomments.comments");

pimcore.plugin.ratingscomments.comments = Class.create({
    ...
    getRowEditor: function () {
        ...
        var proxy = new Ext.data.HttpProxy({
            url: '/plugin/RatingsComments/admin/comments'
        });
        var readerFields = [
            {name: 'c_id'},
            {name: 'c_shorttext'},
